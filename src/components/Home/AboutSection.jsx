...
const AboutSection = () => {
  return (
    <motion.section
      id="about"
      className="py-16 sm:py-24 bg-gradient-to-r from-gray-100 to-gray-200 mt-20"  // Adjusted padding
    ...
    >
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6">About Me</h2>
        
        {/* Grid for blocks, single column on small screens, 3 columns on larger */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-gray-600 mb-4">
          ...
          <div className="p-4 sm:p-6 bg-white rounded-lg shadow-md">
            ...
            <a href="/book" className="text-blue-500 hover:text-blue-700 mt-4 block text-sm sm:text-base">Discover My Book &rarr;</a>
          </div>
        ...
        <a
          href="#testimonials"
          className="mt-8 inline-block bg-blue-500 text-white font-bold py-3 px-6 rounded hover:bg-blue-700 transition text-sm sm:text-base"
        >
